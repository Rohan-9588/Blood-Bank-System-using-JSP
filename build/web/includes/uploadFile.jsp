...
//    out.println(contentType);
    if((contentType!=null) && (contentType.indexOf("multipart/form-data")>=0)){
        ...
        try{
            ...
            int res=db.update_delete("update hospital set photo='"+saveFile+"' where id="+uselogid);
            if(res>0){
                response.sendRedirect("../hospital-profile.jsp?status=11");
            }else{
                response.sendRedirect("../hospital-profile.jsp?status=22");
            }
        }catch(Exception e){
            out.println(e);
        }
