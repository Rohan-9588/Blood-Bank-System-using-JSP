            ...
            <div class="section">
                <div class="container">
                    ...
                    <%
                                    ...
                                    ResultSet rs=db.getHospitalById(uselogid);
                                    if(rs.next())
                                    {
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="background-color: #616367d9; color:white;">
                                ...
                                <table class="table table-bordered">
                                    <tr><th>Hospital Name</th><td><%=rs.getString("name")%></td></tr>
                    ...
                    try{
                                ...
                                %>
                                <br>
                                 <form class="form-horizontal" method="post" enctype="multipart/form-data" action="includes/uploadFile.jsp">
                    ...
                    try{
                                ...
                                <form class="form-horizontal" method="post" action="includes/WebService.jsp">
                                        <input type="hidden" value="changehospipass" name="action"/>
                                        <div class="form-group"> 
